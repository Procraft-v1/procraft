  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        devPortfolio: resolve(__dirname, 'dasturchi-portfolio/index.html'),
        ...
        enCv: resolve(__dirname, 'en/cv-maker/index.html'),
        enDevPortfolio: resolve(__dirname, 'en/developer-portfolio/index.html'),
        ...
        ruCv: resolve(__dirname, 'ru/sozdat-cv/index.html'),
        ruDevPortfolio: resolve(__dirname, 'ru/portfolio-razrabotchika/index.html'),
      },
      output: {
